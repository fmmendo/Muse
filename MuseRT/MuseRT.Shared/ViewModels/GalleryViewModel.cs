...
{
    public class GalleryViewModel : ViewModelBase<RssSchema>
    {
            ...
            get
            {
                if (itemClickCommand == null)
                {
                    itemClickCommand = new RelayCommandEx<RssSchema>(
                        (item) =>
                        {
                            NavigationServices.NavigateToPage("GalleryDetailPage", item);
                        });
                }
        ...
        {
            return new GalleryDataSource(); // RssDataSource
        }
        ...
        {
            NavigationServices.NavigateToPage("GalleryList");
        }

        override protected void NavigateToSelectedItem()
        {
            NavigationServices.NavigateToPage("GalleryDetailPage");
        }
    }
}
